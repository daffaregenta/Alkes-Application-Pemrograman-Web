...
<form action="<?php echo base_url()?>home/ubah_cart" method="post" name="frmweb" id="frmweb" class="form-horizontal" enctype="multipart/form-data">
<?php
...
<td><a href="<?php echo base_url()?>home/hapus/<?php echo $item['rowid'];?>" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a></td>
<?php endforeach; ?>
</tr>
<tr>
...
<a href="<?php echo base_url()?>home/check_out"  class ='btn btn-sm btn-primary'>Check Out</a>
</tr>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
      	<form method="post" action="<?php echo base_url()?>home/hapus/all">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Konfirmasi</h4>
        </div>
        <div class="modal-body">
			Anda yakin mau mengosongkan web Cart?
